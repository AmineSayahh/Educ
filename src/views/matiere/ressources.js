...
class ressources extends Component {
  ...
  getusers() {
    axios.get(`http://localhost:4500/api/getRessources/${localStorage.getItem('userId')}/${localStorage.getItem('idM')}`)
      .then((res => {
              ...
              <Card>
                <CardHeader>
                  ...
                  <CDropdown className="m-1">
                    <CDropdownToggle color="btn btn-light">
                    ...
                    <CDropdownMenu>
                      <CForm className="px-4 py-3">
                        ...
                        <CFormGroup>
                          <CLabel htmlFor="exampleDropdownFormtext1">lien</CLabel>
                          <CInput
                            className="form-control"
                            id="exampleDropdownFormtext1"
                            type="text"
                        ...
                        <CFormGroup className="mt-2">
                          <CButton color="btn btn-light" block type="submit" onClick={(e) => this.envoyer2(e)}>Ajouter un cours</CButton>
                        </CFormGroup>
                      </CForm>
                      <CDropdownDivider />
                    </CDropdownMenu>
